...
if ($_POST['sports']) {
	?>
			 ...
			 ?>
	<h3 >Complete Coach LTD Details</h3>
   <form action="" method="POST" class="jumbotron">
   <h4 class="btn-info">Complete Coach LTD learning development</h4>
   <div class="form-group">
   Coaching Course:
   ...
   <div class="form-group">
                            <label for="inputParent_name">Primary  Duration </label>
                            <div class="input-group">
                                <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-user"></span>
                                </span>
                                <input class="form-control" placeholder="Enter Duration Taken in Primary " type="text" name="pduration" required=""/>
                            </div>
                        </div>

     <div class="form-group">
                            <label for="inputParent_name">Other Details</label>
                            <div class="input-group">
                                <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-user"></span>
                                </span>
   ...
   <div class="form-group">
                            <label for="inputParent_name">Other  Duration </label>
                            <div class="input-group">
                                <span class="input-group-addon">
                                    <span class="glyphicon glyphicon-user"></span>
                                </span>
