...
<div class="container-fluid">
  <h2 class="btn-info">Tutee Registration Panel</h2> 
  <h4>Dear tutee, ensure you go through all the following steps to complete your registration process. <a href="tutee_login.php">Back To Login</a></h4> 
</div>
...
<h3>Personal Details</h3>
   ...
   <?php
   include 'tutee_registration_data_submission.php'; 
  include 'tutee_registration_data.php';
...
<ul>
  ...
  <li>Pay a registration fees of Kshs.1000 to Bussiness number 290***, </li>
  <li>Ensure you pay this fees using Mpesa number you used to register</li>
  <li>Upone approval of your payment, your Complete Coach LTD number will be sent into your email</li>
</ul>
